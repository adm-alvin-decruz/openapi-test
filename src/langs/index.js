module.exports = {
  en: {
    ...
    membership_pass_email_mismatch_mandaiid: 'Email does not match Mandai ID.',
  ...
  zh: {
    ...
    membership_pass_email_mismatch_mandaiid: '电子邮件与 Mandai ID 不匹配。',
    ...
    sendCode_failed: '验证码发送失败。',
    sendCode_success: '验证码已成功发送。',
    sendCode_tooSoon: '请稍等后再请求新的验证码。',
    verifyML_invalid: '链接无效或已过期。请请求一个新的链接。',
    verifyML_missingToken: '令牌缺失或为空',
    verifyOTP_invalid: 'OTP 无效。请重试。',
  ...
  kr: {
    ...
    membership_pass_email_mismatch_mandaiid: '이메일이 Mandai ID와 일치하지 않습니다.',
  ...
  ja: {
    ...
    membership_pass_email_mismatch_mandaiid: 'メールアドレスが Mandai ID と一致しません。',
    ...
    sendCode_failed: '認証コードの送信に失敗しました。',
    sendCode_success: '認証コードが正常に送信されました。',
    sendCode_tooSoon: '次のコードをリクエストする前にお待ちください。',
    verifyML_invalid: 'リンクが無効か期限切れです。新しいリンクをリクエストしてください。',
    verifyML_missingToken: 'トークンが見つからないか、空です。',
    verifyOTP_invalid: 'OTPが無効です。もう一度お試しください。',
    verifyOTP_expired: 'コードの有効期限が切れました。新しいコードをリクエストしてください。',
    verifyOTP_tooManyAttempts: '試行回数が多すぎます。新しいコードをリクエストしてください。',
