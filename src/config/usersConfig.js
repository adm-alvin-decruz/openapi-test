const resConfig = {
  ...
  UPDATE_WP_VALIDATE_PARAMS:'{"email":{"invalid":"The %s is invalid.","not_exist":"This email address does not have a Mandai Account."},"dob":{"range_error":"The dob must between 13 and 99 years old."},"group":{"invalid":"The %s is invalid or empty."}}',
