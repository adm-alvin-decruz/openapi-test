const resConfig = {
  ...
  DATABASE_PARAMS_MAPPING: '{"given_name":"firstName","family_name":"lastName","birthdate":"dob","custom:newsletter":"newsletter", "otp_email_disabled_until":"otpEmailDisabledUntil", "singpass_id":"singpassId"}',
  // validation
  ...
  USERS_UPDATE_API_RESPONSE_CONFIG:
    '{"MWG_CIAM_USER_UPDATE_SUCCESS":{"mwgCode":"MWG_CIAM_USER_UPDATE_SUCCESS","code":200,"message":"User info updated successfully.","status":"success"},"MWG_CIAM_USER_UPDATE_ERR":{"mwgCode":"MWG_CIAM_USER_UPDATE_ERR","code":400,"message":"User info update error.","status":"failed"},"MWG_CIAM_PARAMS_ERR":{"mwgCode":"MWG_CIAM_PARAMS_ERR","code":400,"message":"Wrong parameters.","status":"failed"},"MWG_CIAM_501_ERR":{"mwgCode":"MWG_CIAM_501_ERR","code":501,"message":"Not implemented.","status":"failed"}}',
  RESEND_MEMBERSHIP_API_RESPONSE_CONFIG:
    '{"MWG_CIAM_RESEND_MEMBERSHIP_SUCCESS":{"mwgCode":"MWG_CIAM_RESEND_MEMBERSHIP_SUCCESS","code":200,"message":"Resend %s membership success.","status":"success"},"MWG_CIAM_RESEND_MEMBERSHIPS_ERR":{"mwgCode":"MWG_CIAM_RESEND_MEMBERSHIPS_ERR","code":200,"message":"Resend %s membership failed.","status":"failed"},"MWG_CIAM_PARAMS_ERR":{"mwgCode":"MWG_CIAM_PARAMS_ERR","code":400,"message":"Wrong parameters.","status":"failed"},"MWG_CIAM_USERS_MEMBERSHIP_NULL":{"mwgCode":"MWG_CIAM_USERS_MEMBERSHIP_NULL","code":200,"message":"No record found","status":"failed"}}',
  DELETE_MEMBERSHIP_API_RESPONSE_CONFIG:
    '{"MWG_CIAM_USER_DELETE_SUCCESS":{"mwgCode":"MWG_CIAM_USER_DELETE_SUCCESS","code":200,"message":"Delete membership success.","status":"success"},"MWG_CIAM_USER_DELETE_ERR":{"mwgCode":"MWG_CIAM_USER_DELETE_ERR","code":200,"message":"Delete membership failed.","status":"failed"}}',
  GET_USER_MEMBERSHIPS_API_RESPONSE_CONFIG:
  ...
  GET_USER_API_RESPONSE_MAPPING_WILDPASS_PASSKIT:
  ...
  DB_USERS_MODEL_MAPPING: '{"given_name":"","family_name":"","birthdate":"", "otp_email_disabled_until":"", "singpass_id":""}',
  DB_USER_NEWSLETTER_MAPPING: '{"name":"","type":"","subscribe":""}',

  // update parameters that can trigger Galaxy update:
  TRIGGER_GALAXY_UPDATE_PARAMS_WILDPASS:
    '["given_name","family_name","birthdate","custom:newsletter"]',
