...
CREATE TABLE `emp_membership_user_accounts` (
  ...
  `first_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `newsletter` tinyint(1) DEFAULT NULL,
  `country` varchar(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `emp_membership_user_passes` (
  ...
  `iu` varchar(24) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `car_plate` varchar(24) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valid_from` datetime DEFAULT NULL,
  `valid_until` datetime DEFAULT NULL,
  `plu` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `member_first_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `member_last_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `member_email` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `member_dob` datetime DEFAULT NULL,
  `member_identification_no` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `member_phone_number` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `emp_membership_user_passes_co_member` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pass_id` int DEFAULT NULL,
  `co_member_first_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `co_member_last_name` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `co_member_dob` datetime DEFAULT NULL,
  `applicant_type` varchar(24) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'adult | child',
  `picked` tinyint(1) DEFAULT NULL COMMENT '0: no, 1: yes',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
